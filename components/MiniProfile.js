...
export default function MiniProfile() {
    return (
        <div className="flex items-center justify-between ml-8 m-2 w-full">
            ...
            <div className="flex items-center space-x-4">
                ...
                <div className="">
                    <h2 className=" font-semibold text-sm cursor-pointer">manu__7u7</h2>
                    <h4 className=" text-gray-500 text-xs">Miguel Aguilera</h4>
                </div>
            </div>


            <button className="text-xs text-blue-400 ml-10 font-semibold">Cambiar</button>
        </div>
    )
}
